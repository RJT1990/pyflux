...
def atest_normal_bbvi_mini_batch():
    """
...
def atest_normal_bbvi_mini_batch_elbo():
    """
    Tests that the ELBO increases
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest_normal_predict_length():
    """
...
def atest_normal_predict_is_length():
    """
...
def atest_predict_is_intervals():
    """
    Tests prediction intervals are ordered correctly
    """
    model = pf.GASReg(formula="y ~ x1", data=data, family=pf.Laplace())
...
def atest_predict_is_intervals_bbvi():
    """
    Tests prediction intervals are ordered correctly
    """
    model = pf.GASReg(formula="y ~ x1", data=data, family=pf.Laplace())
...
def atest_predict_intervals_mh():
    """
    Tests prediction intervals are ordered correctly
    """
    """
    ...
    assert(np.all(predictions['5% Prediction Interval'].values > predictions['1% Prediction Interval'].values))
    """
def atest_predict_is_intervals_mh():
    """
    Tests prediction intervals are ordered correctly
    """
    """
...
def atest2_normal_bbvi_mini_batch():
    """
    Tests an ARIMA model estimated with BBVI and that the length of the latent variable
    list is correct, and that the estimated latent variables are not nan
    """
...
def atest2_normal_bbvi_mini_batch_elbo():
    """
    Tests that the ELBO increases
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_normal_predict_length():
    """
    Tests that the length of the predict dataframe is equal to no of steps h
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_normal_predict_is_length():
    """
    Tests that the length of the predict IS dataframe is equal to no of steps h
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_normal_predict_is_nans():
    """
    Tests that the predictions in-sample are not NaNs
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_predict_intervals_bbvi():
    """
    Tests prediction intervals are ordered correctly
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_predict_is_intervals_bbvi():
    """
    Tests prediction intervals are ordered correctly
    """
    model = pf.GASReg(formula="y ~ x1 + x2", data=data, family=pf.Laplace())
...
def atest2_predict_intervals_mh():
    """
    Tests prediction intervals are ordered correctly
    """
    """
    ...
    assert(np.all(predictions['5% Prediction Interval'].values > predictions['1% Prediction Interval'].values))
    """
def atest2_predict_is_intervals_mh():
    """
    Tests prediction intervals are ordered correctly
    """
    """
