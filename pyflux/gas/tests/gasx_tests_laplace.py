...
model_1 = pf.GASX(formula="y ~ x1", data=data, ar=0, sc=0, family=pf.Laplace())
x_1 = model_1.fit()

model_2 = pf.GASX(formula="y ~ x1", data=data, ar=1, sc=1, family=pf.Laplace())
x_2 = model_2.fit()

model_3 = pf.GASX(formula="y ~ x1", data=data, ar=1, sc=1, integ=1, family=pf.Laplace())
x_3 = model_3.fit()

model_4 = pf.GASX(formula="y ~ x1", data=data, ar=2, sc=2, family=pf.Laplace())
x_4 = model_4.fit()

model_b_1 = pf.GASX(formula="y ~ x1 + x2", data=data, ar=0, sc=0, family=pf.Laplace())
x_1 = model_b_1.fit()

model_b_2 = pf.GASX(formula="y ~ x1 + x2", data=data, ar=1, sc=1, family=pf.Laplace())
x_2 = model_b_2.fit()

model_b_3 = pf.GASX(formula="y ~ x1 + x2", data=data, ar=1, sc=1, integ=1, family=pf.Laplace())
x_3 = model_b_3.fit()

model_b_4 = pf.GASX(formula="y ~ x1 + x2", data=data, ar=2, sc=2, family=pf.Laplace())
x_4 = model_b_4.fit()
